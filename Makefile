...
export KBUILD_CFLAGS CFLAGS_KERNEL CFLAGS_MODULE CFLAGS_KCOV CFLAGS_GCOV CFLAGS_KASAN
...
ifdef CONFIG_KCOV
  ifeq ($(call cc-option, $(CFLAGS_KCOV)),)
      $(warning Cannot use CONFIG_KCOV: -fsanitize-coverage=trace-pc is not supported by compiler)
	CFLAGS_KCOV =
  endif
endif
